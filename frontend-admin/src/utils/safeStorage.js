 ...
 * not a function turned five Agent Portal test suites red through
 ...
 *
 * ADR-003: `frontend/src/utils/safeStorage.js` is the same file — the two apps
 * share no package. Keep the two in sync.
 */
