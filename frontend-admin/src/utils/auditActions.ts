...
export const AUDIT_ACTION_GROUPS: AuditActionGroup[] = [
  ...
  {
    label: 'การอนุมัติสมาชิก',
    prefix: 'agent_approval.',
    actions: [
      { value: 'agent_approval.approved', label: 'อนุมัติสมาชิก' },
      { value: 'agent_approval.approved_by_leader', label: 'หัวหน้าทีมอนุมัติสมาชิก' },
      { value: 'agent_approval.rejected', label: 'ปฏิเสธสมาชิก' },
      { value: 'agent_approval.revoked', label: 'ถอนการอนุมัติสมาชิก' },
  ...
  {
    label: 'เงินและค่าแนะนำ',
    actions: [
      { value: 'commission_rule.created', label: 'สร้างกฎค่าแนะนำ' },
      { value: 'commission_rule.updated', label: 'แก้ไขกฎค่าแนะนำ' },
      { value: 'commission_split_setting.updated', label: 'แก้ไขการแบ่งค่าแนะนำสมาชิกร่วม' },
      { value: 'commission_ledger.marked_paid', label: 'ทำเครื่องหมายว่าจ่ายค่าแนะนำแล้ว' },
      { value: 'commission_withdrawal.requested', label: 'ขอเบิกค่าแนะนำ' },
      { value: 'settings.commission_withdrawal_minimum_updated', label: 'แก้ไขยอดขั้นต่ำในการเบิก' },
      { value: 'platform_commission_settings.updated', label: 'แก้ไขค่าแนะนำระดับแพลตฟอร์ม' },
      { value: 'agent_promotion_credit.paid', label: 'จ่ายเครดิตโปรโมชั่นให้สมาชิก' },
    ],
  },
  {
