 ...
 *   <Icon name="check" class="text-emerald-600" />
 *
...
const PATHS: Record<string, string> = {
    ...
    // TASK-055 follow-up — "display settings" glyph: monitor/screen outline
    // with a small cog inside (single-path: screen rect + stand + gear).
    // Mobile phone + gear ("app / mobile settings") — phone body, speaker,
    // home dot, motion lines at left, and an 8-tooth cog at lower-right.
    display_cog: 'M7 4h4a2 2 0 012 2v12a2 2 0 01-2 2H7a2 2 0 01-2-2V6a2 2 0 012-2z M8 6.4h2 M9 17.6h.01 M3.5 8H2 M4 11.5H1.5 M3.5 15H2 M16.5 10.5a3 3 0 100 6 3 3 0 000-6z M16.5 12.6a.9 .9 0 100 1.8 .9 .9 0 000-1.8z M16.5 10.5V9.2 M16.5 16.5v1.3 M19.5 13.5h1.3 M18.62 11.38l.92-.92 M14.38 15.62l-.92.92 M18.62 15.62l.92.92 M14.38 11.38l-.92-.92',
