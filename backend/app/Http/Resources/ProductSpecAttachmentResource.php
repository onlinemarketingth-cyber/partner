...
class ProductSpecAttachmentResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'stream_url' => $this->source_type === MediaSourceType::Upload && $this->file_path
                ? route('product-spec-attachments.stream', $this->id)
                : null,
            'thumbnail_url' => $this->thumbnail_path ? route('product-spec-attachments.thumbnail', $this->id) : null,
